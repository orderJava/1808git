    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                ...
                <form method="post" name="copy_form" id="copy_form" action="goods.do?m=insertGoods" enctype="multipart/form-data">
                    <div class="widget-main">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="file" name="good_pic" id="smfile&quot;" style="width:540px;height:22px;cursor:hand" class="fileinput" onchange="checkImgType(this);setPreview(this,'sm_yl','sm_div',240,150);">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="file" name="good_pic1" id="smfile1&quot;" style="width:540px;height:22px;cursor:hand" class="fileinput" onchange="checkImgType(this);setPreview(this,'sm_yl1','sm_div1',240,150);">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="file" name="good_pic2" id="smfile2&quot;" style="width:540px;height:22px;cursor:hand" class="fileinput" onchange="checkImgType(this);setPreview(this,'sm_yl2','sm_div2',240,150);">
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    function submitData(){
        var gid = "";
        var url = "goods.do?m=insertGoods";
